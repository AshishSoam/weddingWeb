...
@Component({
  ...
  styleUrls: ['./add-user-step2.component.scss']
})
export class AddUserStep2Component implements OnInit {
  countryArr = [
    {
      "country": "India",
  ...
  userDetails          : any;
  showBasicDetails     : boolean = false;
  showAbouts           : boolean = false;
  showPhysicalDetails  : boolean = false;
  showReligionDetails  : boolean = false;
  ...
  constructor(public httpService :HttpService, public commonService : CommonService, public router : Router) { 
    this.addUserForm2 = new FormGroup({       
      userAge                  :     new FormControl('', []),
      userMathab               :     new FormControl('', []),
      userReligion             :     new FormControl('', []),
      userLanguage             :     new FormControl('', []),
      userTribe                :     new FormControl('', []),
      userTribeName            :     new FormControl('', []),
      userCountry              :     new FormControl('', []),
      userCity                 :     new FormControl('', []),
      userEducation            :     new FormControl('', []),
      userEmployedIn           :     new FormControl('', []),
      userOccupation           :     new FormControl('', []),
      userBodyType             :     new FormControl('', []),
      userComplexion           :     new FormControl('', []),
      userPhysicalStatus       :     new FormControl('', []),
      userHeight               :     new FormControl('', []),
      userWeight               :     new FormControl('', []),
      userCulture              :     new FormControl('', []),
      userFamilyGatherings     :     new FormControl('', []),
      userHijab                :     new FormControl('', []),
      userAbaya                :     new FormControl('', []),
      userHairType             :     new FormControl('', []),
      userHairColor            :     new FormControl('', []),
      userSmokingHabits        :     new FormControl('', []),
      userHubblyBubbly         :     new FormControl('', []),
      userEatingHabits         :     new FormControl('', []),
      // userProfilePhoto         :     new FormControl('', []),
      userIncome               :     new FormControl('', []),
      userFamilyStatus         :     new FormControl('', []),
      userLifestyle            :     new FormControl('', []),
      userDrinkingHabits       :     new FormControl('', []),
      // userMatchingPictures     :     new FormControl('', []),      
      familyBio                :     new FormControl('', []), 
    });
  }
  ...
  registrationFunc() {
    let data = {    
      userAge                  :  this.addUserForm2.value.userAge,
      userMathab               :  this.addUserForm2.value.userMathab,
      userReligion             :  this.addUserForm2.value.userReligion,
      userLanguage             :  this.addUserForm2.value.userLanguage,
      userTribe                :  this.addUserForm2.value.userTribe,
      userTribeName            :  this.addUserForm2.value.userTribeName,
      userCountry              :  this.addUserForm2.value.userCountry,
      userCity                 :  this.addUserForm2.value.userCity,
      userMaritalstatus        :  this.addUserForm2.value.userMaritalstatus,
      userEducation            :  this.addUserForm2.value.userEducation,
      userEmployedIn           :  this.addUserForm2.value.userEmployedIn,
      userOccupation           :  this.addUserForm2.value.userOccupation,
      userBodyType             :  this.addUserForm2.value.userBodyType,
      userComplexion           :  this.addUserForm2.value.userComplexion,
      userPhysicalStatus       :  this.addUserForm2.value.userPhysicalStatus,
      userHeight               :  this.addUserForm2.value.userHeight,
      userWeight               :  this.addUserForm2.value.userWeight,
      userCulture              :  this.addUserForm2.value.userCulture,
      userFamilyGatherings     :  this.addUserForm2.value.userFamilyGatherings,
      userHijab                :  this.addUserForm2.value.userHijab,
      userAbaya                :  this.addUserForm2.value.userAbaya,
      userHairType             :  this.addUserForm2.value.userHairType,
      userHairColor            :  this.addUserForm2.value.userHairColor,
      userSmokingHabits        :  this.addUserForm2.value.userSmokingHabits,
      userHubblyBubbly         :  this.addUserForm2.value.userHubblyBubbly,
      userEatingHabits         :  this.addUserForm2.value.userEatingHabits,
      userProfilePhoto         :  this.userImg,
      userIncome               :  this.addUserForm2.value.userIncome,
      userFamilyStatus         :  this.addUserForm2.value.userFamilyStatus,
      userLifestyle            :  this.addUserForm2.value.userLifestyle,
      userDrinkingHabits       :  this.addUserForm2.value.userDrinkingHabits,
      userMatchingPictures     :  '',
      editMemberId             :  localStorage.getItem('editMemberId') || '',
    ...
    this.httpService.post('user/editProfile',data,1).subscribe(res => {
      ...
      if(res.responseCode == 200){
        ...
        this.router.navigateByUrl('member/addUserStep-3');
      }
    },err => {
  ...
  showPhysicalCollapsible() {
    this.showPhysicalDetails = !this.showPhysicalDetails;
  }

  showReligionCollapsible() {
    this.showReligionDetails = !this.showReligionDetails;
  }

  showHealthCollapsible() {
