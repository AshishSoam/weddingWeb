...
@Component({
  selector: 'app-add-user-step3',
  templateUrl: './add-user-step3.component.html',
  styleUrls: ['./add-user-step3.component.scss']
})
export class AddUserStep3Component implements OnInit {
  userDetails : any;
  ageFilter : boolean = false;
  maritalStatusFilter : boolean = false;
  countryFilter : boolean = false;
  religionFilter : boolean = false;
  toungeFilter : boolean = false;
  incomeFilter : boolean = false;
  desiredPartnerBio : any;
  countryArr = [
    {
      "country": "India",
  ...
  //save Edit Variables
  showAgeEditButton : boolean = true;
  showMaritalEditBtn : boolean = true;
  constructor(public httpService :HttpService, public commonService : CommonService, public router : Router) { 
    this.addUserForm3 = new FormGroup({ 
      ...
      partnerHeight              :       new FormControl('', []),
      partnerHeightUnit          :       new FormControl('', []),//
      partnerMaritalStatus       :       new FormControl('', []),
      partnerCountry             :       new FormControl('', [,Validators.pattern('[a-zA-Z ]*')]),
      partnerCity                :       new FormControl('', [,Validators.pattern('[a-zA-Z ]*')]),
      partnerReligion            :       new FormControl('', []),
      partnerEducation           :       new FormControl('', []),
      partnerOccupation          :       new FormControl('', []),
      partnerIncome              :       new FormControl('', []),
      partnerDrinkingHabits      :       new FormControl('', []),
      partnerSmokingHabits       :       new FormControl('', []),
      partnerComplexion          :       new FormControl('', []),
      partnerBodyType            :       new FormControl('', []),
      PartnerBio                 :       new FormControl('', []),
      partnerTribe               :       new FormControl('', []),
      partnerHairColor           :       new FormControl('', []),   
      partnerMathab              :       new FormControl('', []),
      partnerLanguage            :       new FormControl('', []),
      partnerTribeName           :       new FormControl('', []),
      partnerEmployedIn          :       new FormControl('', []),
      partnerPhysicalStatus      :       new FormControl('', []),
      partnerWeight              :       new FormControl('', []),
      partnerCulture             :       new FormControl('', []),
      partnerFamilyGatherings    :       new FormControl('', []),
      partnerHijab               :       new FormControl('', []),
      partnerAbaya               :       new FormControl('', []),
      partnerHairType            :       new FormControl('', []),
      partnerHubblyBubbly        :       new FormControl('', []),
      partnerEatingHabits        :       new FormControl('', []),
      partnerProfilePhoto        :       new FormControl('', []),//
      partnerFamilyStatus        :       new FormControl('', []),
      partnerLifestyle           :       new FormControl('', []),
      partnerMatchingPictures    :       new FormControl('', []),//
...
window.scrollTo(0,0);
  ...
  showHideCollapsible() {
    this.showBasicDetails = !this.showBasicDetails;
      ...
      this.showPhysicalDetails  = false;
      this.showReligionDetails  = false;
  ...
  // editSaveAgeFunc(type) {
  //   switch (type){
  //     case 1:
  //      this.showAgeEditButton = false;   
  //     break;
  //     case 2 :
  //      this.showAgeEditButton = true;   
  //     break;
  //     default :
  //     break;
  //   }    
